...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-10-2023 a las 19:23:20
...
(1, 'Cyborg Of The End', 'Robert Steel', 1, 2012),
(2, 'Heir Of Fire', 'Emily Blackwood', 1, 1903),
(3, 'Gangsters Of The End', 'Vincent Rossi', 1, 1995),
(4, 'Kings Of The Sea', 'Alexander Oceanson', 1, 2010),
(5, 'Witches And Guardians', 'Isabella Nightshade', 1, 1954),
(6, 'Children And Creators', 'Olivia Craft', 1, 1985),
...
(19, 'Smiles In Nature', 'Oliver Greenfield', 1, 1923),
(20, 'Blood In The South', 'Diego Sangre', 1, 1952),
...
--
ALTER TABLE `libros`
  MODIFY `id_libro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=221;
